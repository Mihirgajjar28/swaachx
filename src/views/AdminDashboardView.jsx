      ...
      <div className="animate-fade-in-up" style={{ paddingBottom: '40px' }}>
        ...
        {adminTab === 'overview' && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            {/* Quick Action Matrix for the logged-in admin */}
            <div className="glass-card" style={{ padding: '20px' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '12px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Zap size={18} color="var(--accent-amber)" />
                <span>{isSuperAdmin ? 'Executive Commissioner Controls' : isSanitationDirector ? 'Sanitation Directorate Action Deck' : 'Tactical Logistics & Dispatch Deck'}</span>
              </h3>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '12px' }}>
                {isSuperAdmin ? (
                  <>
                    <button
                      onClick={() => setAdminTab('ward-rankings')}
                      className="btn btn-secondary"
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <BarChart3 size={20} color="#0ea5e9" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Inspect 48 Ward Sanitation Rankings</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Review SLA completion league and citizen happiness indices</div>
                      </div>
                    </button>

                    <button
                      onClick={() => setAdminTab('directives')}
                      className="btn btn-secondary"
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Zap size={20} color="#f59e0b" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Manage Emergency Directives</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Toggle Monsoon flood protocols & festive mandates</div>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Download size={20} color="#10b981" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Export SBM State Compliance Audit</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>One-click CSV download of tamper-evident system logs</div>
                      </div>
                    </button>
                  </>
                ) : isSanitationDirector ? (
                  <>
                    ...
                    >
                      ...
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Arbitrate Citizen Grievances & Fines</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Verify AI before/after cleanups and penalize violators</div>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Flame size={20} color="#f43f5e" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Deploy AI CCTV ML Hotspot Cameras</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Monitor waste surge zones with automated dispatch rules</div>
                      </div>
                    </button>

                    <button
                      onClick={() => setAdminTab('quests-approval')}
                      className="btn btn-secondary"
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Users size={20} color="#0ea5e9" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Approve Community Cleanliness Quests</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Sanction AMC equipment & volunteer certifications</div>
                      </div>
                    </button>
                  </>
                ) : (
                  <>
                    <button
                      onClick={() => setAdminTab('gis-map')}
                      className="btn btn-secondary"
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Layers size={20} color="#8b5cf6" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Live City GIS Telemetry Grid</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Track 10 compactor trucks across Ahmedabad corridors</div>
                      </div>
                    </button>

                    <button
                      onClick={() => setAdminTab('dispatch-overrides')}
                      className="btn btn-secondary"
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Zap size={20} color="#f59e0b" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Dynamic Emergency Dispatch Overrides</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Force-reroute compactor units to critical surge points</div>
                      </div>
                    </button>

                    <button
                      onClick={() => setAdminTab('dustbins')}
                      className="btn btn-secondary"
                      style={{ padding: '14px', textAlign: 'left', display: 'flex', alignItems: 'flex-start', gap: '10px' }}
                    >
                      <Trash2 size={20} color="#10b981" style={{ flexShrink: 0, marginTop: '2px' }} />
                      <div>
                        <div style={{ fontWeight: 800, fontSize: '13px', color: 'var(--text-primary)' }}>Smart IoT Sensor Calibration</div>
                        <div style={{ fontSize: '11px', color: 'var(--text-muted)', marginTop: '2px' }}>Adjust ultrasonic offset, battery levels, & sensor health</div>
                      </div>
                    </button>
                  </>
                )}
